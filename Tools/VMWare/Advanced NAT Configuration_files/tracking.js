...
if (window.location.host == 'wcm.vmware.com' || window.location.host == 'wwwa-qa-sso-1.vmware.com' || window.location.host == 'govirtual-jive-dev-1.vmware.com' || window.location.host == 'vmweb-test.vmware.com' || window.location.host == 'supportuat.vmware.com' || window.location.host == 'vmshare-stage.vmware.com'  || window.location.host.match(/^siebwebdev/) || window.location.host.match(/^siebwebtest/) || window.location.host.match(/^eservice-stage/) || window.location.host.match(/^phnx-portal/) || window.location.host == 'newcastle.vmware.com' || window.location.host == 'vmworld2009-test.wingateweb.com' || window.location.host == 'portal-vmwperf.vmware.com' || window.location.host == 'cs2.salesforce.com') {
        s_account="vmwaredev"
        ...
        s.dynamicAccountMatch=window.location.host
} else if (window.location.host == 'na6.salesforce.com') {
...
function s_doPlugins(s) {
  ...
  /* 404 Page Not Found */
  if(document.title.match(/^Page not found - VMware$/)) {
        s.pageName="";
  ...
  if (campaign_id && campaign_id.match(/#(\w+)?$/)) {
        campaign_id = campaign_id.replace(/^([^#]+)#(\w+)?$/, "$1")
  }
