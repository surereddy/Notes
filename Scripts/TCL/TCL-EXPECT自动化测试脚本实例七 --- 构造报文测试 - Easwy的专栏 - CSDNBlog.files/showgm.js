...
{
	var outhtml='<div id="csdn_ad" class="postTitle">特别推荐：<div style="display: inline; margin-left: 300px;"><a href="http://adtag.csdn.net/" target="_blank">想在这里投放广告？点击查看详情</a> </div><img src="/Images/ad_close.gif" alt="关闭" onclick="display(csdn_ad);" style="cursor:hand;" width="14" height="14"  border="0"><ul class="postText">';
	for (var k in gms)
	 {
