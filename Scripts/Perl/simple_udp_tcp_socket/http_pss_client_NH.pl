...
#test socket	
	...
	#while(1)
	{
		...
		#\0d\0a is same as \r\n and is automaticallly added by UltraEdit. 	
		  $msg="GET /smp/user/PrepareVauUrl.do?UserId=000000123456780002&PUID-ChannelNo=000000192168021020-1&PlayMethod=0&Offset=0&PuProperty=1&VAUADD=218.80.215.198:2325&PUName=DVS2 HTTP/1.1\r\n".
