...
# Last Update: 3/14, 2014  - Add swap -s and update iostat.
...
echo "What IO_DISK_STRING to grep for iostat? Check by iostat -xn first, an example is c0t0d0. Default = ${IO_DISK_STRING}.:"
